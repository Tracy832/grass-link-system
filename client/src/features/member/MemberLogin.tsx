    ...
    >
      <div className="bg-white/70 backdrop-blur-lg p-8 rounded-3xl shadow-2xl w-full max-w-xs border border-white/30 relative overflow-hidden">
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          <button 
            type="submit"
            className="w-full bg-green-700 text-white py-3 rounded-xl font-bold hover:bg-green-800 transition-all text-xs shadow-lg mt-4 active:scale-95"
          >
            LOG IN
          </button>
        </form>
        ...
        <div className="mt-8 text-center">
          <p className="text-[11px] text-gray-600">
            Don't have an account? <Link to="/signup" className="ml-1 text-green-800 font-bold hover:underline">Sign Up</Link>
          </p>
        </div>
      </div>
    </div>
